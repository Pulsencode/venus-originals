...
<body>
    ...
    <?php include 'includes/components/side_bar.php'; ?>
    <!-- Start Hero -->
    <div class="cs-hero cs-style1 cs-bg cs-fixed_bg cs-shape_wrap_1" data-src="assets/img/hero_bg.jpeg" id="home">
        ...
        <div class="container">
            <div class="cs-hero_text">
                <h1 class="cs-hero_title wow fadeInRight" data-wow-duration="0.8s" data-wow-delay="0.2s">Unleashing<br>
                    Animation's Power</h1>
                        ...
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <div class="cs-hobble">
                                <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                                    ...
                                    <div class="cs-card_info">
                                        ...
                                        <h2 class="cs-card_title">Motion Graphics</h2>
                                    </div>
                                </a>
                            </div>
                            <div class="cs-height_0 cs-height_lg_30 mt-2">
                                <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                                    ...
                                    <div class="cs-card_info">
                                        <span class="cs-hover_layer3 cs-accent_bg"></span>
                                        <h2 class="cs-card_title">3D Animation</h2>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <div class="cs-hobble">
                                <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                                    ...
                                    <div class="cs-card_info">
                                        <span class="cs-hover_layer3 cs-accent_bg"></span>
                                        <h2 class="cs-card_title">CGI & VFX</h2>
                                    </div>
                                </a>
                            </div>
                            <div class="cs-height_0 cs-height_lg_30 mt-2">
                                <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                                    ...
                                    <div class="cs-card_info">
                                        <span class="cs-hover_layer3 cs-accent_bg"></span>
                                        <h2 class="cs-card_title">AI Animations</h2>
                                    </div>
                                </a>
                            </div>
                        </div>
                        <div class="col-lg-3 col-sm-6 mt-2">
                            <div class="cs-hobble">
                                <a href="service-details.html" class="cs-card cs-style1 cs-hover_layer1">
                                    ...
                                    <div class="cs-card_info">
                                        <span class="cs-hover_layer3 cs-accent_bg"></span>
                                        <h2 class="cs-card_title">2D Animation</h2>
                                    </div>
                                </a>
                            </div>
                            <!-- <div class="cs-height_0 cs-height_lg_30 mt-2">
